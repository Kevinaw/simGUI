...
/**
 * @brief SimguiApp::initActions Initializes all QActions of the application
 */
void SimguiApp::initActions()
{
...
*/
  ...
  callEditor->setStatusTip(tr("Starts the Simgui text editor"));
  callEditor->setWhatsThis(tr("Text editor\n\nStarts the Simgui text editor"));
  ...
  callFilter->setStatusTip(tr("Starts SimguiFilter"));
  ...
  callLine->setStatusTip(tr("Starts SimguiTrans"));
  ...
  callLib->setStatusTip(tr("Starts SimguiLib"));
  ...
  callAtt->setStatusTip(tr("Starts SimguiAttenuator"));
  ...
  callRes->setStatusTip(tr("Starts Simgui resistor color codes"));
...
//  viewMenu->addAction(viewOctaveDock);
  ...
  QDir TechnicalDir = QDir(SimguiSettings.DocDir.replace('\\','/'));
...
//Fill submenu's with filenames of PDF documents
  QDir ReportDir = QDir(SimguiSettings.DocDir.replace('\\','/'));
...
//Fill submenu's with filenames of PDF documents
  QDir TutorialDir = QDir(SimguiSettings.DocDir.replace('\\','/'));
...
// ----------------------------------------------------------
void SimguiApp::slotShowWarnings()
{
...
// ----------------------------------------------------------
void SimguiApp::slotResetWarnings()
{
...
// ----------------------------------------------------------
void SimguiApp::printCursorPosition(int x, int y)
{
...
void SimguiApp::slotViewToolBar(bool toggle)
{
  if (toggle== false) {
    fileToolbar->hide();
    editToolbar->hide();
...
void SimguiApp::slotViewStatusBar(bool toggle)
{
  if (toggle == false)
    statusBar()->hide();
  else
...
void SimguiApp::slotViewBrowseDock(bool toggle)
{
  if (toggle == false)
    dock->hide();
  else
...
// ----------------------------------------------------------
void SimguiApp::slotToggleDock(bool on)
{
...
void SimguiApp::slotViewOctaveDock(bool toggle)
{
  if(toggle) {
    octDock->show();
    octave->startOctave();
...
// ----------------------------------------------------------
void SimguiApp::slotToggleOctave(bool on)
{
...
// ----------------------------------------------------------
void SimguiApp::slotHelpAbout()
{
  QMessageBox::about(this, tr("About..."),
    tr("Simgui Version")+" "+PACKAGE_VERSION+"\n"+
...
// ----------------------------------------------------------
void SimguiApp::slotHelpAboutQt()
{
