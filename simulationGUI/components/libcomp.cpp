...
LibComp::LibComp()
{
  ...
  Description = QObject::tr("Component taken from Simgui library");
  ...
  Props.append(new Property("Lib", "", true,
		QObject::tr("name of simgui library file")));
...
{
  QDir Directory(SimguiSettings.LibDir);
  ...
  if(Section.left(14) != "<Simgui Library ")  // wrong file type ?
    return -2;
