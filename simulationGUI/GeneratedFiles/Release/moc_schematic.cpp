...
static const char qt_meta_stringdata_Schematic[] = {
    "Schematic\0\0slotScrollUp()\0slotScrollDown()\0"
    "slotScrollLeft()\0slotScrollRight()\0"
};
...
void Schematic::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->slotScrollUp(); break;
        case 1: _t->slotScrollDown(); break;
        case 2: _t->slotScrollLeft(); break;
        case 3: _t->slotScrollRight(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
void *Schematic::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "SimguiDoc"))
        return static_cast< SimguiDoc*>(const_cast< Schematic*>(this));
