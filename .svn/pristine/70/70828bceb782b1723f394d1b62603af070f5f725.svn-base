...
SimguiDoc::SimguiDoc(SimguiApp *App_, const QString& Name_)
{
  App = App_;
...
QString SimguiDoc::fileSuffix (const QString& Name) {
  QFileInfo Info (Name);
  return Info.extension (false);
}

QString SimguiDoc::fileSuffix (void) {
  return fileSuffix (DocName);
}

QString SimguiDoc::fileBase (const QString& Name) {
  QFileInfo Info (Name);
  return Info.baseName (true);
}

QString SimguiDoc::fileBase (void) {
